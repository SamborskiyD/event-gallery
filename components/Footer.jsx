...
const Footer = () => {
  return (
    <footer className=" bg-secondaryBlack py-6 px-10 flex gap-5 items-center justify-center flex-wrap md:justify-between text-primaryGrey">
      <Link
        href="/"
        className="flex items-center gap-2.5 text-extrabold text-2xl"
      >
        <svg
      ...
      <nav>
        <ul className=" flex items-center justify-center flex-wrap gap-y-2 gap-x-10">
          <li>
            <Link
              href="#"
              className=" text-bold text-lg cursor-pointer hover:text-primaryOrange"
            >
              Contact Us
            </Link>
          </li>
      ...
      <div className=" flex items-center gap-10">
        <Link href="#" aria-label="icon">
          <svg
            className="h-8 w-8 hover:text-primaryOrange"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
            <path
